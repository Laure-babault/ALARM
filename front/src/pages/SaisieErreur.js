                ...
                {activeStep === 1 && (
                     ...
                     <><Card style={{ backgroundColor: '#fcfbfc', boxShadow: '0px 3px 5px rgba(0, 0, 0, 0.3)', padding: '20px' }}>
                        ...
                        <Grid item xs={12}>
                            ...
                            <Grid item xs={12}>
                                <Typography variant="h7">Quoi? Que s'est-il passé ? </Typography>   <Grid item xs={12}>
                                    <TextField
                            ...
                            <Grid item xs={12}>
                                <Typography variant="h7">Quel impact cela a-t-il eu ? </Typography>   <Grid item xs={12}>
                                    <TextField
                                        id="outlined-multiline-static"
                                        multiline
                                        rows={1}
                            ...
                            <Grid item xs={12}>
                                <Typography variant="h7">En quoi est-ce un problème ? </Typography>   <Grid item xs={12}>
                                    <TextField
                                        id="outlined-multiline-static"
                                        multiline
                                        rows={1}
...
/>
 ...
 <label>
  <input type="radio" name="options" value="option2" />
 Un médicament qui est <b>Non Réfrigéré</b> </label><br></br>
   <label>
  <input type="radio" name="options" value="option3" />
  Un supéfiant </label><br></br>
  <label>
  <input type="radio" name="options" value="option4" />
  Une chimiothérapie <b>Réfrigérée</b> </label>
  <label>
  <input type="radio" name="options" value="option5" />
  Une chimiothérapie <b>Non Réfrigérée</b> </label>
   </Grid>
